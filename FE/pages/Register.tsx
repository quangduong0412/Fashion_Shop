      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.keyboardView}>
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Bắt đầu phong cách mới của bạn</Text>
          </View>
          ...
          <BlurView intensity={20} tint="dark" style={styles.formCard}>
            ...
            <View style={styles.inputContainer}>
              <Ionicons name="checkmark-circle-outline" size={20} color="#ddd" style={styles.inputIcon} />
              <TextInput 
                value={form.confirm} 
...
const styles = StyleSheet.create({ 
  ...
  accent: { color: '#e63946' }, 
  subtitle: { color: '#eee', fontSize: 16, textAlign: 'center', fontStyle: 'italic' },
